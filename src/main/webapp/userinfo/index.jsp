...
<script>
	...
	$(function(){
		$('#dg').datagrid({   
		    ...
		    pagination:true,
		    columns:[[   
		    	{field:'userinfoid',checkbox:'checkbox',title:'编号'},      
...
<div id="win" class="easyui-window" title="My Window" style="width:600px;height:400px"  
	    ...
	    <div>  
	        ...
	        <input class="easyui-validatebox" type="text" name="currentaddress" data-options="required:true" />  
	    </div> 
	    <div>  
	    ...
	    <div>  
	        <label for="usericon">usericon:</label>  
	        <input class="easyui-validatebox" type="text" name="usericon" data-options="required:true" />  
	    </div>
	    <div>  
	    ...
	    <div>  
	        <label for="userjob">userjob:</label>  
	        <input class="easyui-validatebox" type="text" name="userjob" data-options="required:true" />  
	    </div> 
	    <div>  
	    ...
	    <div>  
	        ...
	        <input class="easyui-numberbox" type="text" name="salary" data-options="required:true" />  
	    </div> 
	    <div>  
	        <label for="ismarried">ismarried:</label>  
	        <input class="easyui-numberbox" type="text" name="ismarried" data-options="required:true" />  
	    </div> 
	    <div>  
