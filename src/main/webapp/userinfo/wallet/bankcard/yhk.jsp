		...
		$('#dg').datagrid({   
		    ...
		    columns:[[   
		        ...
		        {field:'operate',title:'操作',width:100,formatter: function(value,row,index){
		        	var btns = "<a id=\"btn\" href=\"javascript:deleteItem("+row.bankcardid+")\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-remove'\">删除</a>";
		        	btns += "<a id=\"btn\" href=\"javascript:findById("+row.bankcardid+")\" class=\"easyui-linkbutton\" data-options=\"iconCls:'icon-edit'\">修改</a>"; 
					return btns;
				}
				},
...
<body>
	...
	<div id="win" class="easyui-window" title="My Window"
		...
		<form id="ff" method="post">
			...
			<div>
				<label for="userid">bankcardnum:</label> <input
					class="easyui-validatebox" type="text" name="bankcardnum"
					data-options="required:true" />
			</div>
			<div>
				<label for="username">bankcardname:</label> <input
					class="easyui-validatebox" type="text" name="bankcardname"
					data-options="required:true" />
			</div>
			<div>
				<label for="currentaddress">walletid:</label> <input
					class="easyui-validatebox" type="text" name="walletid"
					data-options="required:true" />
			</div>
