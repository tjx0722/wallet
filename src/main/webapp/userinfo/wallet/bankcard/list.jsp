...
<script>
	...
	$(function(){
		$('#dg').datagrid({   
		    ...
		    pagination:true,
		    columns:[[   
		    	{field:'bankcardid',checkbox:'checkbox',title:'银行卡表id'},      
...
<div id="win" class="easyui-window" title="My Window" style="width:600px;height:400px"  
	    ...
	    <div>  
	        <label for="userid">bankcardnum:</label>  
	        <input class="easyui-validatebox" type="text" name="bankcardnum" data-options="required:true" />  
	    </div>  
	    <div>  
	        <label for="username">bankcardname:</label>  
	        <input class="easyui-validatebox" type="text" name="bankcardname" data-options="required:true" />  
	    </div> 
	    <div>  
	        <label for="currentaddress">walletid:</label>  
	        <input class="easyui-validatebox" type="text" name="walletid" data-options="required:true" />  
	    </div> 
